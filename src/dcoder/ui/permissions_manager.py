...
class PermissionsManagerScreen(ModalScreen[None]):
    ...
    Mirrors Claude Code's /permissions TUI adapted for DCoder's DevOps scopes
    ...
    def _render_rule_list(self, option_list: OptionList, category: str) -> None:
        ...
        desc = {
            "allow": "DCoder won't ask before using allowed tools.",
            "ask": "DCoder will prompt for confirmation every time.",
    ...
    def _render_workspace(self, option_list: OptionList) -> None:
        ...
        source_labels = {
            ...
            "config": "💾 Config Rules (~/.dcoder/config.toml)",
