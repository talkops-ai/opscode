"""Atomic TOML configuration persistence for DCoder matching dcode reference implementation."""
...
from dcoder.config.paths import CONFIG_PATH, STATE_DIR
...
def load_theme_preference(config_path: Path | None = None) -> str:
    """Load theme preference from [ui].theme in config.toml, defaulting to 'dcoder-dark'."""
    data = read_config_toml(config_path)
