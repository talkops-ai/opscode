...
- **Grader middleware**: the nested grader receives dcoder's verification
...
def _without_internal_control_messages(state: RubricState) -> RubricState:
    """Remove dcoder control turns before the SDK builds grader evidence.
...
with warnings.catch_warnings():
    ...
    class ReliableRubricMiddleware(RubricMiddleware):
        ...
        The nested grader receives dcoder's verification middleware and runtime
