"""Adapter from plugin MCP declarations to DCoder MCP config dictionaries."""
...
from dcoder.plugins._json import json_object, json_value
from dcoder.plugins.substitution import plugin_environment, substitute_json

if TYPE_CHECKING:
    from dcoder.plugins.models import JsonObject, JsonValue, PluginInstance
