...
installed once on the `dcoder` package logger (see `__init__.py`); child
...
from dcoder.config.env_vars import LOG_LEVEL
...
def install_log_buffer(
    ...
    `import dcoder` attaches the handler and may lower the package
