"""First-run interactive onboarding wizard for dcoder."""
...
ONBOARDING_NAME_MEMORY_START = "<!-- dcoder:onboarding-name:start -->"
ONBOARDING_NAME_MEMORY_END = "<!-- dcoder:onboarding-name:end -->"
...
def run_onboarding_if_needed(agent_name: str = "dcoder") -> None:
    """Run onboarding on interactive terminal if ~/.dcoder/{agent}/AGENTS.md is missing."""
    user_md = settings.user_dcoder_dir / agent_name / "AGENTS.md"
    if user_md.exists():
        return
    ...
    print("====================================================")
    print("      Welcome to DCoder (DevOps Coder) Setup!       ")
    print("====================================================")
    try:
