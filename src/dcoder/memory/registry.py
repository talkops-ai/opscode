...
class MemoryRegistry:
    ...
    def get_memory_paths_for_scope(self, scope: str) -> list[Path]:
        ...
        if scope in ("user", "auto"):
            # ~/.dcoder/dcoder/AGENTS.md
            user_md = settings.user_dcoder_dir / "dcoder" / "AGENTS.md"
        ...
        if scope in ("project", "auto"):
            if settings.project_root:
                # {project_root}/.dcoder/AGENTS.md
                paths.append(settings.project_root / ".dcoder" / "AGENTS.md")
        ...
        if scope == "auto":
            memories_dir = settings.user_dcoder_dir / "dcoder" / "memories"
