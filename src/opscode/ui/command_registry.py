"""Unified slash-command registry for OpsCode.
...
COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand(
        name="/version",
        description="Show OpsCode version and environment info",
        bypass_tier=BypassTier.ALWAYS,
        hidden_keywords="ver build info",
    ),
    SlashCommand(
        name="/config",
        description="View and manage OpsCode configuration",
        bypass_tier=BypassTier.IMMEDIATE_UI,
    ...
    SlashCommand(
        name="/doctor",
        description="Run diagnostic health checks on OpsCode environment",
        bypass_tier=BypassTier.QUEUED,
    ...
    SlashCommand(
        name="/update",
        description="Check for and install OpsCode software updates",
        bypass_tier=BypassTier.QUEUED,
