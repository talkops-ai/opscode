"""Rich-rendered help screens for OpsCode CLI commands and subcommands."""
...
PRIMARY = DC_TEAL
MUTED = DC_MUTED
DOCS_URL = "https://opscode.ai/docs"
...
def show_help() -> None:
    ...
    console.print()
    console.print(f"[bold {PRIMARY}]opscode[/bold {PRIMARY}] v{__version__}")
    console.print()
    console.print(
    ...
    console.print("  opscode [OPTIONS]                           Start interactive session")
    console.print("  opscode agents <list|reset>                 Manage agents")
    console.print("  opscode skills <list|info|trust>            Manage agent skills")
    console.print("  opscode plugin <list|install|uninstall>     Manage plugins")
    console.print("  opscode threads <list|delete>               Manage conversation threads")
    console.print("  opscode mcp <config|login|list>             Manage MCP servers")
    console.print("  opscode config [get <key>|set|path]         Inspect configuration")
    console.print("  opscode auth <list|set|remove|status|path>  Manage provider credentials")
    console.print("  opscode doctor                              Print install diagnostics")
    console.print("  opscode tools <list|install>                Manage external tools")
    console.print()

    console.print("[bold]Options:[/bold]", style=PRIMARY)
    console.print("  -r, --resume [ID]          Resume thread: -r for most recent, -r ID for specific")
    console.print("  -a, --agent NAME           Agent to use (default: opscode)")
    ...
    console.print("  --trust-project-hooks      Trust project .opscode/hooks.json handlers")
    ...
    console.print("  -v, --version              Show opscode version")
    console.print("  -h, --help                 Show this help message and exit")
    console.print()

    console.print("[bold]Non-Interactive Mode Examples:[/bold]", style=PRIMARY)
    console.print("  opscode -n 'Plan terraform deployment'           # Headless task execution", style=MUTED)
    console.print("  opscode -n 'List files' -S recommended           # Safe shell commands", style=MUTED)
    console.print("  opscode -n 'Search logs' -S ls,cat,grep -q       # Quiet piping mode", style=MUTED)
    console.print("  cat prompt.txt | opscode --stdin -q              # Read from stdin", style=MUTED)
    console.print()


def show_agents_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode agents <command> [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_list_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode agents list [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_reset_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode agents reset --agent NAME [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_skills_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode skills <command> [OPTIONS]", style=PRIMARY)
    console.print()
    console.print("[bold]Commands:[/bold]", style=PRIMARY)
...
def show_skills_list_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode skills list [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_skills_info_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode skills info NAME [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_skills_trust_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode skills trust NAME [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_plugins_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode plugin <command> [OPTIONS]", style=PRIMARY)
    console.print()
    console.print("[bold]Commands:[/bold]", style=PRIMARY)
...
def show_config_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode config [get <key>|set <key> <value>|path] [OPTIONS]", style=PRIMARY)
    console.print()
    console.print("Inspect or update OpsCode configuration values.", style=MUTED)
    console.print()
    console.print("[bold]Commands:[/bold]", style=PRIMARY)
...
def show_auth_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode auth <command> [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_threads_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode threads <command> [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_threads_list_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode threads list [OPTIONS]", style=PRIMARY)
    console.print()
    console.print("[bold]Options:[/bold]", style=PRIMARY)
...
def show_threads_delete_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode threads delete <thread_id> [OPTIONS]", style=PRIMARY)
    console.print()
    console.print("[bold]Options:[/bold]", style=PRIMARY)
...
def show_doctor_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode doctor [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_tools_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode tools <command> [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_tools_list_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode tools list [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_tools_install_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode tools install [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_mcp_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode mcp <command> [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_mcp_config_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode mcp config [OPTIONS]", style=PRIMARY)
    console.print()
...
def show_mcp_login_help() -> None:
    console.print()
    console.print("[bold]Usage:[/bold] opscode mcp login <server> [OPTIONS]", style=PRIMARY)
    console.print()
