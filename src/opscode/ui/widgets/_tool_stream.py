...
- the interactive Textual TUI (`opscode.ui.textual_adapter`), and
- the headless runner (`opscode.client.non_interactive`).

This module holds the single implementation of the buffering, argument parsing,
and payload-shape logic, so the two surfaces cannot drift.
"""
...
from opscode.integrations.hooks import HOOK_TOOL_OUTPUT_LIMIT
