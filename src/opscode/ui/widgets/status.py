...
from opscode.config.env_vars import HIDE_CWD, HIDE_GIT_BRANCH, is_env_truthy
from opscode.config.settings import get_glyphs
from opscode.ui.widgets.loading import Spinner
from opscode.utils.session_stats import format_cost
...
class StatusBar(Horizontal):
    ...
    def on_mount(self) -> None:
        ...
        if self._hide_git_branch:
            ...
            from opscode.utils.git import read_git_branch_from_filesystem
            try:
