...
plugins and marketplaces in OpsCode.
"""
...
from opscode.config.settings import get_glyphs, is_ascii_mode
...
from opscode.plugins.models import InstallScope, LocalPluginSource, PluginInstance, PluginMarketplace, split_plugin_id
        ...
        for plugin in marketplace.plugins:
            ...
            if instance is None and is_project_marketplace:
                ...
                if source_root is not None:
                    from opscode.plugins.project_plugins import _build_plugin_instance
