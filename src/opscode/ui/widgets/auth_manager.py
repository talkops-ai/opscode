...
from opscode.model.config import get_credential_env_var
from opscode.ui.widgets.auth import AuthPromptScreen, AuthResult, PROVIDER_DISPLAY_NAMES
...
class AuthManagerScreen(ModalScreen[None]):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical():
            ...
            yield Static(
                ...
                "Keys are stored in ~/.opscode/.env.",
    ...
    def action_delete_selected(self) -> None:
        ...
        try:
            ...
            from opscode.model.config import revoke_provider_credentials
