...
**Global** (`~/.opscode/AGENTS.md` or `~/.agents/AGENTS.md`): Universal preferences across all projects
**Project** (`.opscode/AGENTS.md`, `AGENTS.md`, or `.agents/AGENTS.md`): Project-specific conventions and decisions
...
### Skill Location
- **User skill**: `~/.opscode/skills/<skill-name>/SKILL.md` or `~/.agents/skills/<skill-name>/SKILL.md`
- **Project skill**: `.opscode/skills/<skill-name>/SKILL.md` or `.agents/skills/<skill-name>/SKILL.md`
