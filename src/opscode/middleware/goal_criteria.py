...
from opscode.middleware._repository_bounds import (
...
def create_goal_criteria_agent(
    *,
    ...
    from opscode.agent.factory import _should_interrupt_tool_call, _format_description
    ...
    return create_agent(
    ...
    ).with_config(
        {
            ...
            "run_name": "OpsCode goal criteria generation",
        }
    )
    ...
    *,
    ...
    return create_agent(
    ...
    ).with_config(
        {
            ...
            "run_name": "OpsCode goal criteria fallback",
        }
    )
