...
from opscode.config.settings import resolve_env_var, _get_settings
from opscode.exceptions import (
    ModelConfigError,
...
def _get_provider_kwargs(provider: str, *, model_name: str | None = None) -> dict[str, Any]:
    ...
    from opscode.model.reasoning import with_effort_model_params
