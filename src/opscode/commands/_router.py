...
from opscode.commands._types import SafetyLevel
...
class CommandRouter:
    ...
    def get_handler(self, command_name: str) -> BaseCommandHandler | None:
        ...
        Supports exact match first, then prefix match for ``/skill:*`` commands.
        """
    ...
    def auto_discover(self) -> None:
        ...
        sub_packages = [
            "opscode.commands.core",
            "opscode.commands.power",
            "opscode.commands.devops",
        ]
        ...
        try:
            from opscode.plugins.adapters.commands import discover_plugin_commands
