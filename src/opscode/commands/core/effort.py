"""Reasoning effort command handler for OpsCode."""
...
class EffortHandler(BaseCommandHandler):
    ...
    async def execute(self, ctx: CommandContext) -> CommandResult:
        ...
        if level == "clear":
            from opscode.config.toml_config import save_effort_for_model
        ...
        from opscode.model.reasoning import supported_efforts_for_model
        ...
        os.environ["OPSCODE_REASONING_EFFORT"] = level
