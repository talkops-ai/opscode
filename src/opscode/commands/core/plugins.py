...
class PluginsHandler(BaseCommandHandler):
    ...
    async def execute(self, ctx: CommandContext) -> CommandResult:
        ...
        if args_text:
            import shlex
            import argparse
            from opscode.plugins.commands_cli import setup_plugin_parser, execute_plugin_command

            parser = argparse.ArgumentParser(prog="opscode", add_help=False)
        ...
        from opscode.plugins import discover_marketplace_plugins, list_available_plugins
