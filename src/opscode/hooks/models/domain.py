...
from opscode.json_types import JSON_VALUE_ADAPTER, JsonObject, JsonValue
...
class OpscodeNotificationKind(StrEnum):
    """OpsCode lifecycle notifications with compatible wire mappings."""
...
DcodeNotificationKind = OpscodeNotificationKind
...
class OpscodeNotification(_DomainModel):
    """A notification emitted by a OpsCode lifecycle owner."""
...
# Backward compatibility alias
DcodeNotification = OpscodeNotification
...
class NotificationEvent(_DomainModel):
    ...
    notification: OpscodeNotification
