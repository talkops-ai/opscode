...
from opscode.config.env_vars import (
    DEBUG,
    DEBUG_FILE,
    DEFAULT_DEBUG_FILE,
    LOG_LEVEL,
...
_DEBUG_HANDLER_ATTR = "_opscode_debug_handler"
LOG_LEVELS = {
    "DEBUG": logging.DEBUG,
    "INFO": logging.INFO,
...
def configure_debug_logging(target: logging.Logger) -> None:
    ...
    Intended to be called once on the `opscode` package logger; child
...
def installed_debug_log_path() -> Path | None:
    ...
    """
    package_logger = logging.getLogger(__package__ or "opscode")
