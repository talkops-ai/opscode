...
async def _make_graph() -> Any:
    ...
    def _make_graph_sync() -> Any:
        ...
        from opscode.project_utils import get_server_project_context
        ...
        if not config.no_mcp:
            ...
            from opscode.mcp.trust import compute_config_fingerprint, is_project_mcp_trusted
        ...
        agent, _composite_backend = create_opscode_agent(
