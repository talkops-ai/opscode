...
_REJECTION_MESSAGE = (
    "The region between the `opscode:onboarding-name:start` and "
    "`opscode:onboarding-name:end` markers in {path} is machine-managed and "
...
_DELETE_REJECTION_MESSAGE = (
    ...
    "the `opscode:onboarding-name:start` and `opscode:onboarding-name:end` "
